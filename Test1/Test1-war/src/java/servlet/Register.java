...
"    </head>";
        ...
        String body = "<body class=\"newsletter\" style=\"width: 100%; height: 100%\">\n" +
...
"                        </div>\n" +
"                        <div class='newsletter_form d-flex flex-md-row flex-column flex-xs-column align-items-center justify-content-center'>\n" +
"                            <br><p><a href='index.html'>Sudah memiliki memiliki account?</a></p>\n" +
"                        </div>\n" +
"                    </form>\n" +
"                </div>\n" +
"            </div>";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body style='padding-top:20%'>");
            out.println("<h1> "+ ex.getMessage().toString() +" </h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
